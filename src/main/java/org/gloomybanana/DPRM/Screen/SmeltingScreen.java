...
public class SmeltingScreen extends AbstractRecipeMakerScreen<SmeltingContainer> {
    ...
    public void onConfirmBtnPress(Button button) {
        JSONObject smeltingRecipe = JsonManager.genSmeltingRecipe(container.furnaceSlots, groupNameInput.getText(),Doubles.tryParse(experienceInput.getText()),Ints.tryParse(cookingTimeInput.getText()));
