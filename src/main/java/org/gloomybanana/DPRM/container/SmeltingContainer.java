...
public class SmeltingContainer extends AbstractRecipeContainer {
    ...
    public SmeltingContainer(int sycID, PlayerInventory playerInventory, PacketBuffer packetBuffer) {
        super(Registry.smeltingContainer.get(), sycID,playerInventory,packetBuffer);
