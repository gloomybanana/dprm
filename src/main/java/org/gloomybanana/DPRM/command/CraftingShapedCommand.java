...
import org.gloomybanana.DPRM.containerprovider.DPRMContainerProvider;
...
public class CraftingShapedCommand implements Command<CommandSource> {
    ...
    public int run(CommandContext<CommandSource> context) throws CommandSyntaxException {
        ...
        NetworkHooks.openGui(serverPlayer,new DPRMContainerProvider(serverPlayer), (packerBuffer) -> {
