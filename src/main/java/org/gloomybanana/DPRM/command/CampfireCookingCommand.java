...
import org.gloomybanana.DPRM.containerprovider.CampfireCookingContainerProvider;
import org.gloomybanana.DPRM.containerprovider.SmeltingContainerProvider;

public class CampfireCookingCommand implements Command<CommandSource> {
    public static CampfireCookingCommand instance = new CampfireCookingCommand();
    ...
    public int run(CommandContext<CommandSource> context) throws CommandSyntaxException {
        ...
        NetworkHooks.openGui(serverPlayer,new CampfireCookingContainerProvider(serverPlayer), (packetBuffer) -> {
