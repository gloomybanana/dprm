...
public class  Registry {
    ...
    public static RegistryObject<ContainerType<RecipeMenuContainer>> recipeListContainer = CONTAINERS_TYPE.register("recipe_menu_container",() -> IForgeContainerType.create(RecipeMenuContainer::new));
    public static RegistryObject<ContainerType<CreateRecipeMenuContainer>> createRecipeContainer = CONTAINERS_TYPE.register("create_recipe_menu_container",() ->IForgeContainerType.create(CreateRecipeMenuContainer::new));
