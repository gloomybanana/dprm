...
public class CampfireCookingScreen extends AbstractRecipeMakerScreen<CampfireCookingContainer> {
    ...
    public void onConfirmBtnPress(Button button) {
        JSONObject campfireCookingRecipe = JsonManager.genCampfireCookingRecipe(container.furnaceSlots, groupNameInput.getText(),Doubles.tryParse(experienceInput.getText()),Ints.tryParse(cookingTimeInput.getText()));
