...
import org.gloomybanana.DPRM.dao.CreateRecipeJson;


public class CreateCommand implements Command<CommandSource> {
    public static CreateCommand instance = new CreateCommand();
    @Override
    public int run(CommandContext<CommandSource> context) throws CommandSyntaxException {
        ...
        jsonPacket.put("recipe_list", CreateRecipeJson.getAllRecipes(jsonPacket));
