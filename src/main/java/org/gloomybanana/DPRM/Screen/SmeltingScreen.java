...
public class SmeltingScreen extends AbstractRecipeMakerScreen<SmeltingContainer> {
    ...
    public SmeltingScreen(SmeltingContainer smeltingContainer, PlayerInventory inv, ITextComponent titleIn) {
        ...
        SCREEN_TEXTURE = new ResourceLocation(DPRM.MOD_ID, "textures/gui/smelting.png");
    }
    ...
    public void onConfirmBtnPress(Button button) {
        JSONObject smeltingRecipe = JsonManager.genSmeltingRecipe(container.furnaceSlots, groupNameInput.getText(),0.35d,200);
